...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?= base_url('assets/css/themes/blue.css');?>" />
			...
			<ul class="nav navbar-nav pull-right">
				...
				<li class="dropdown user">
					...
					<ul class="dropdown-menu">
						<li>
							<a href="<?= base_url("{$base_dashboard_path}/profile/view/edit");?>"><i class="fa fa-gear"></i> Setting</a>					
						</li>
						<li>
							<a href="<?= base_url("{$base_dashboard_path}/profile/view");?>"><i class="fa fa-user"></i> Profile</a>
						</li>
						<li>
							<a href="<?= base_url("{$base_dashboard_path}/account/logout");?>"><i class="fa fa-key"></i> Log Out</a>				
						</li>
					</ul>
				</li>
