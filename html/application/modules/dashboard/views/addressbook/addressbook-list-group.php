		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						<li class="btn-group">
							<a href="<?= base_url($base_path . '/index.php/addressbook/addgroup');?>" class="btn green pull-right">
						...
						<li>
							<i class="fa fa-briefcase"></i> Groups
						</li>
					</ul>
			...
			<div class="row">
				...
				<div class="col-md-6 pull-right">
					<form action="<?= base_url($base_path . '/index.php/addressbook/listgroup');?>" class="form-horizontal" role="form" id="searh-form" method="post">
						<div class="input-group">
							<input name="search_text" class="form-control" placeholder="Search Group" type="text" id="search_text" value="<?=$search_text;?>" />
