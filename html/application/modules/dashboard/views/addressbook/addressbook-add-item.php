				...
				<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
					<div class="box box-primary">
						...
						<div class="box-body no-padding">
							<form id="addressbook-add" action="<?php echo base_url($base_path . '/index.php/addressbook/addaction/item') ?>" method="post" role="form">
								<div class="form-body">
									<div class="form-group required">
										<div class="row">
											<div class="col-md-6">
												<label for="item_name">Item Name</label>
												<input type="text" class="form-control required" id="item_name"  name="item_name" maxlength="120">
											</div>
											<div class="col-md-6">
												<label for="group_seq">Item Group</label>
												<select class="form-control required" id="group_seq" name="group_seq">
						...
						<div class="box-footer">
							<div class="form-group">
								<button id="save-this-item" type="submit" class="btn btn-primary">Save Item</button>
